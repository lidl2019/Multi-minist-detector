...
AdamP_PROFILE = OptimizerProfile(AdamP, {
        "lr": 0.0005,
        "betas": (0.9, 0.99),
        "eps": 1e-8

})
AdamP_PROFILE_6 = OptimizerProfile(AdamP, {
        "lr": 0.0005,
        "betas": (0.9, 0.99),
        "eps": 1e-8,
        "weight decay": 1e-6
...
SGDP_PROFILE = OptimizerProfile(SGDP, {
        'lr': 0.0005,
        'momentum': 0.9,
        'weight_decay': 0
})
SGDP_PROFILE_0 = OptimizerProfile(SGDP, {
        'lr': 0.0005,
        'momentum': 0.9,
        'weight_decay': 0
})
SGD_PROFILE_6 = OptimizerProfile(SGD, {
        'lr': 0.0005,
        'momentum': 0.9,
        'weight_decay': 1e-6
})
SGDP_PROFILE_5 = OptimizerProfile(SGDP, {
        'lr': 0.0005,
        'momentum': 0.9,
        'weight_decay': 1e-5
})
SGDP_PROFILE_4 = OptimizerProfile(SGDP, {
        'lr': 0.0005,
        'momentum': 0.9,
        'weight_decay': 1e-4
})

# ADAM_PROFILE_w = OptimizerProfile(Adam, {
#             "lr": 0.0005,
#             "betas": (0.9, 0.99),
#             "eps": 1e-8
#         })
...
def run_alex(n_way: int, depth: Tuple[int, int, int], Opt_name: str,scaled: bool, relabeled: bool, Optim_PROFILE = ADAM_PROFILE,rotation_augment = False, ignorext = False, semisupervised = False):
    print(f"n_way: {n_way}")
    print(f"depth: {depth}")
    ...
    trained_alex_net_PATH = Path(trained_alex_net_PATH / f"{n_way}way-depth{depth}_{Opt_name}")
    ...
    alex.set_optimizer(Optim_PROFILE)
    # print("Op")
    if semisupervised:
...
if __name__ == '__main__':
    ...
    # run_alex(1, (3, 4, 4), scaled=False, relabeled=False, rotation_augment=False, semisupervised=False)
    ...
    print("start with ADAM PROFILE")
    run_alex(1, (3, 4, 4),
             scaled=False,
             Opt_name="ADAM",
             relabeled=False,
             Optim_PROFILE=ADAM_PROFILE,
             rotation_augment=False,
             semisupervised=False)
    print("start with SGD PROFILE")
    run_alex(1, (3, 4, 4),
             scaled=False,
             relabeled=False,
             Opt_name="SGD",
             Optim_PROFILE=SGD_PROFILE,
             rotation_augment=False,
             semisupervised=False)
    print("start with AdamP PROFILE")
    run_alex(1, (3, 4, 4),
             scaled=False,
             relabeled=False,
             Opt_name="ADAM_P",
             Optim_PROFILE=AdamP_PROFILE,
             rotation_augment=False,
             semisupervised=False)
    print("start with SGDP PROFILE")
    run_alex(1, (3, 4, 4),
             scaled=False,
             relabeled=False,
             Opt_name="SGD_P",
             Optim_PROFILE=SGDP_PROFILE,
             rotation_augment=False,
             semisupervised=False)
    run_alex(1, (3, 4, 4),
             scaled=False,
