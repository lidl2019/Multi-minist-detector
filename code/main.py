...
def run_alex(n_way: int, depth: Tuple[int, int, int], scaled: bool, relabeled: bool, Optim_PROFILE = ADAM_PROFILE,rotation_augment = False, ignorext = False, semisupervised = False):
    print(f"n_way: {n_way}")
    print(f"depth: {depth}")
    training_set = read_train_labeled(DATASET_PATH)
    validation_proportion = 0.1
    ...
    trained_alex_net_PATH = Path(trained_alex_net_PATH / f"{n_way}way-depth{depth}Optim{Optim_PROFILE}")
